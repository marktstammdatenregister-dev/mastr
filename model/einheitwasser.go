...
// EinheitenWasser
type EinheitenWasser struct {
	XMLName         xml.Name        `xml:"EinheitenWasser"`
	EinheitenWasser []EinheitWasser `xml:"EinheitWasser"`
}

type EinheitWasser struct {
	XMLName                                            xml.Name `xml:"EinheitWasser"`
	...
	ArtDerWasserkraftanlage                            uint     `xml:"ArtDerWasserkraftanlage"` // referenziert Katalogwert
	...
	MinderungStromerzeugung                            string   `xml:"MinderungStromerzeugung"`
	...
	ArtDesZuflusses                                    uint     `xml:"ArtDesZuflusses"` // referenziert Katalogwert
	EegMaStRNummer                                     string   `xml:"EegMaStRNummer"`  // referenziert AnlageEegWasser
