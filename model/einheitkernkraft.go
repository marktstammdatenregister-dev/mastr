...
// EinheitenKernkraft
type EinheitenKernkraft struct {
	XMLName            xml.Name           `xml:"EinheitenKernkraft"`
	EinheitenKernkraft []EinheitKernkraft `xml:"EinheitKernkraft"`
}

type EinheitKernkraft struct {
	XMLName                                xml.Name `xml:"EinheitKernkraft"`
