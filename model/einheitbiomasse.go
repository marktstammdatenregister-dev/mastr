...
// EinheitenBiomasse
type EinheitenBiomasse struct {
	XMLName           xml.Name          `xml:"EinheitenBiomasse"`
	EinheitenBiomasse []EinheitBiomasse `xml:"EinheitBiomasse"`
}

type EinheitBiomasse struct {
	XMLName                                xml.Name `xml:"EinheitBiomasse"`
	...
	Biomasseart                            uint     `xml:"Biomasseart"`     // referenziert Katalogwert
	Technologie                            uint     `xml:"Technologie"`     // referenziert Katalogwert
	EegMaStRNummer                         string   `xml:"EegMaStRNummer"`  // referenziert AnlageEegBiomasse
